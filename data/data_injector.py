...
from information import STATE, NITS, BRANCHES
...
conn = mysql.connect("localhost","root","","jee")
cursor = conn.cursor()
...
for i in range(1,70):
	...
	cursor.execute("INSERT INTO jee.student VALUES(%d,'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s',1,%d,%d,%.1f,%.1f,%.1f,NULL,NULL,NULL,NULL,NULL,NULL)"%(ID,name,father,
